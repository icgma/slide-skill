...
Reference full template: `/tmp/slide-skill/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/tmp/slide-skill/.claude/get-shit-done/templates/state.md`.

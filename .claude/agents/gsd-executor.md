...
@/tmp/slide-skill/.claude/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/tmp/slide-skill/.claude/get-shit-done/references/ios-scaffold.md
...
@/tmp/slide-skill/.claude/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**See @/tmp/slide-skill/.claude/get-shit-done/references/checkpoints.md**
...
**Use template:** @/tmp/slide-skill/.claude/get-shit-done/templates/summary.md

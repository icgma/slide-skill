...
<required_reading>
@/tmp/slide-skill/.claude/get-shit-done/references/verification-overrides.md
...
@/tmp/slide-skill/.claude/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/tmp/slide-skill/.claude/get-shit-done/references/few-shot-examples/verifier.md

...
<required_reading>
@/tmp/slide-skill/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/tmp/slide-skill/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /tmp/slide-skill/.claude
                  → checks /tmp/slide-skill/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /tmp/slide-skill/.claude/get-shit-done
                  → writes to /tmp/slide-skill/.claude/get-shit-done/hooks/
...
@/tmp/slide-skill/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/tmp/slide-skill/.claude/get-shit-done/references/common-bug-patterns.md

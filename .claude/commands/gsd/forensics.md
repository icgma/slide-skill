...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>

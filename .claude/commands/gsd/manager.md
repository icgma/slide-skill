...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/manager.md end-to-end.

...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/health.md
</execution_context>

<process>
Execute the health workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/health.md end-to-end.

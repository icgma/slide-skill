...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/milestone-summary.md
</execution_context>
...
<process>
Read and execute the milestone-summary workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/milestone-summary.md end-to-end.
</process>

...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/docs-update.md end-to-end.

...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/inbox.md
</execution_context>
...
<process>
Execute the inbox workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/inbox.md end-to-end.

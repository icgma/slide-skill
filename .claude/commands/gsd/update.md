...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/update.md
</execution_context>
...
- Otherwise: **Follow the update workflow** from `@/tmp/slide-skill/.claude/get-shit-done/workflows/update.md`.
...
@/tmp/slide-skill/.claude/get-shit-done/workflows/sync-skills.md
@/tmp/slide-skill/.claude/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>

...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
Execute the quick workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/quick.md end-to-end.

...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/review.md
</execution_context>
...
<process>
Execute the review workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/review.md end-to-end.
</process>

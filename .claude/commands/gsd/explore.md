...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/explore.md
</execution_context>

<process>
Execute the explore workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/explore.md end-to-end.
</process>

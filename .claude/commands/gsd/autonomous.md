...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/autonomous.md
...
<process>
Execute the autonomous workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/autonomous.md end-to-end.

...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/code-review.md
</execution_context>
...
Execute the code-review workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/code-review.md end-to-end.

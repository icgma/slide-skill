...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/execute-phase.md end-to-end.

...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/plan-phase.md
...
<process>
Execute the plan-phase workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/plan-phase.md end-to-end.

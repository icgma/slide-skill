...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>

...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/plan-review-convergence.md
...
<process>
Execute the plan-review-convergence workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/plan-review-convergence.md end-to-end.

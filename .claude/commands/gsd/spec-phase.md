...
<execution_context>
@/tmp/slide-skill/.claude/get-shit-done/workflows/spec-phase.md
@/tmp/slide-skill/.claude/get-shit-done/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @/tmp/slide-skill/.claude/get-shit-done/workflows/spec-phase.md end-to-end.

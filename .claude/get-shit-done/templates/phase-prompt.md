...
<!-- For checkpoint task examples and patterns, see @/tmp/slide-skill/.claude/get-shit-done/references/checkpoints.md -->
...
See `/tmp/slide-skill/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/tmp/slide-skill/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/tmp/slide-skill/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.

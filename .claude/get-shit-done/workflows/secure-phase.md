...
```
Task(
  prompt="Read /tmp/slide-skill/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/tmp/slide-skill/.claude/get-shit-done/templates/SECURITY.md`

...
Key references:
- @/tmp/slide-skill/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/tmp/slide-skill/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/tmp/slide-skill/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/tmp/slide-skill/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/tmp/slide-skill/.claude/get-shit-done/USER-PROFILE.md" "/tmp/slide-skill/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /tmp/slide-skill/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/tmp/slide-skill/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/tmp/slide-skill/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /tmp/slide-skill/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /tmp/slide-skill/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /tmp/slide-skill/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /tmp/slide-skill/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /tmp/slide-skill/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/tmp/slide-skill/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /tmp/slide-skill/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /tmp/slide-skill/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /tmp/slide-skill/.claude/CLAUDE.md
```

...
```markdown
Read /tmp/slide-skill/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /tmp/slide-skill/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /tmp/slide-skill/.claude/agents/gsd-ui-checker.md for instructions.

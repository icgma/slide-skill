...
```bash
INIT=$(node "/tmp/slide-skill/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/tmp/slide-skill/.claude/get-shit-done/templates/spec.md.

...
See /tmp/slide-skill/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /tmp/slide-skill/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /tmp/slide-skill/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /tmp/slide-skill/.claude/get-shit-done/templates/discovery.md
...
Use /tmp/slide-skill/.claude/get-shit-done/templates/discovery.md.
